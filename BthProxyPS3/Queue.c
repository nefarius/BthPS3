...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, BthProxyPS3QueueInitialize)
#endif

NTSTATUS
BthProxyPS3QueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = BthProxyPS3EvtIoDeviceControl;
    queueConfig.EvtIoStop = BthProxyPS3EvtIoStop;
    queueConfig.EvtIoInternalDeviceControl = BthProxyPS3EvtIoInternalDeviceControl;
...
VOID
BthProxyPS3EvtIoInternalDeviceControl(
    _In_ WDFQUEUE Queue,
    _In_ WDFREQUEST Request,
    _In_ size_t OutputBufferLength,
    _In_ size_t InputBufferLength,
