...
$product = New-PartnerProductPayload -ProductName 'BthPS3 2.12.0 2.12.0.2012' -AnnouncementDate '2026-09-09T00:00:00'
...
$submission = New-PartnerSubmissionPayload -Name 'BthPS3 2.12.0.2012'
...
$getJson = @'
{
  ...
  "name": "BthPS3 2.12.0 2.12.0.2012 submission",
  "type": "initial",
  "commitStatus": "commitComplete",
  "downloads": {
    "items": [
...
$temp = Join-Path ([IO.Path]::GetTempPath()) ("bthps3-partner-" + [guid]::NewGuid().ToString('N'))
